...
#         self._api_secret = os.environ["AMADEUS_API_SECRET"]
#         self._api_key = os.environ["AMADEUS_API_KEY"]
#         self._token ="CzOCuPiGjYvj2bVVKcKSZgZNI59a"
#         # self._token = self._get_new_token()
#
#     def get_iata(self, data):
#         headers = {"Authorization": f"Bearer {self._token}"}
#         location = data.strip()
#         print(headers)
#
#         # amadeus = Client(
#         #     grant_type='client_credentials',
#         #     client_id="PUtR7ReOvFHnZfDKK2RKPNfY3O2THYU4",
#         #     client_secret="I74jVGk2GQr7iGge")
#         # print(f"Using this token to get destination {self._token}")
#         # try:
#         #     '''
#         #     What's the airline name for the IATA code BA?
#         #     '''
#         #     response = amadeus.reference_data.airlines.get(keyword=location)
#         #     print(response.data)
...
#         except IndexError:
#             print(f"IndexError: No airport code found for {location}.")
#             return "N/A"
#         except KeyError:
#             print(f"KeyError: No airport code found for {location}.")
#             return "Not Found"
#
#     def _get_new_token(self):
